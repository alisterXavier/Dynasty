...
export const HoverEffect = ({ items, className }: any) => {
  ...
  return (
    ...
    >
      {items.map(
        (item: { image: any; name: any; designation: any }, idx: string) => (
          <div
            key={idx}
...
export const CardImage = ({ className, children }: any) => {
  return (
...
export const CardTitle = ({ className, children }: any) => {
  return (
    <h4
      className={cn(
        'text-black linguistics font-bold tracking-wide mt-4',
        className
      )}
    >
      {children}
...
export const CardDescription = ({ className, children }: any) => {
  return (
    <p
      className={cn(
        'text-black tracking-wide leading-relaxed text-sm titillium',
        className
      )}
    >
      {children}
