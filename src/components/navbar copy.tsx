"use client"
import logo from '@/images/logo/DYNASTY_WHITE.png';
    ...
    >
      ...
      <Menu setActive={setActive}>
        ...
        <Link className="text-offwhite p-4" href={'/'}>
          <p className="optima">Home</p>
        </Link>
        <MenuItem setActive={setActive} active={active} item="About">
          <div className="flex flex-col space-y-4 text-sm optima">
...
const Navbar = () => {
  ...
  return isSmallScreen || isAdmin ? <NavbarSmall /> : <NavbarLarge className={undefined} />;
};
